...
私は「プロダクト開発は子育て」と実感しています。ヨチヨチあるきから、立ち上がり、歩き始め、あるときは転び、その過程で本当の正解がわからない中、様々なIssue(顧客課題/開発/マーケティング/セールス/CS対応/品質管理...etc)対応しなければいけません。  

  
  
どれだけ **「ジブンゴト」** にできるかでプロダクトの成長・成功が左右されるか身を持って経験しました。  
