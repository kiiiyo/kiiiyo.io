...
// TODO: MDXにする
import { document } from '@/documents/bit-bear-club'

const Hero: FC = () => {
  return (
    <div className="py-8 bg-neutral-400">
      <div className="flex flex-row items-center p-8 mx-auto max-w-full sm:max-w-3xl md:py-16 lg:max-w-5xl">
        ...
        <h2 className="text-4xl font-bold text-white md:text-6xl">Bit Bear Club</h2>
      </div>
    </div>
  )
}

const BitBearClubPage: NextPage = () => {
  return (
    <Fragment>
      <Head>
      ...
      <Pages.PortfolioSinglePage
        ...
        sidebar={
          <Fragment>
            <div>
              <Link href="https://www.bitbearclub.art/">
                <a target="_blank">
                  <div className="flex items-center p-4 h-full bg-white hover:bg-neutral-50 active:bg-neutral-100 rounded-md shadow-sm">
                    ...
                    <div>
                      <h2 className="font-bold text-neutral-800">Web Site</h2>
                    </div>
            ...
            <div className="mt-6">
              <Link href="https://github.com/kiiiyo/bbc-web-site">
                <a target="_blank">
                  <div className="flex items-center p-4 h-full bg-white hover:bg-neutral-50 active:bg-neutral-100 rounded-md shadow-sm">
                    <div className="mr-3">
...
export default BitBearClubPage
